window.GC_FORM_CONFIG = {
    ...
    "fare":  {
                 "頁面標題":  "車資試算",
                 "頁面引導標題":  "想快速知道車資？可先自行試算",
                 "頁面說明":  "使用 Google 地圖查看最短路線的公里數與預估時間，依下方費率即可快速估算，免等小編回覆。",
                 "人工協助提示":  "不方便自行試算？也可填寫上下車地址送出估價需求；繁忙時段客服可能先提供快速試算方式，若無法操作可直接告知。",
                 "上車標題":  "上車地址",
                 "上車提示":  "請輸入完整地址或明確地標",
                 "下車標題":  "下車地址",
                 "下車提示":  "請輸入完整地址或明確地標",
                 ...
                 "訊息欄位_備註":  "",
                 "成功標題":  "✅ 估價需求已成功送出",
                 "成功內容1":  "估價資料已送出，客服將依序處理。\\n繁忙時段可能先提供快速試算方式，若無法操作可直接告知。",
                 "成功內容2":  "本次僅為車資試算，\\n尚未建立叫車或預約需求。",
                 "返回按鈕":  "返回 LINE 聊天室"
             }
};
