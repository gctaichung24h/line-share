window.GC_FORM_CONFIG = {
    ...
    "fare":  {
                 ...
                 "路線步驟標題":  "① 先確認較短距離路線",
                 "路線步驟說明":  "輸入上下車地點後開啟 Google 地圖；若有多條路線，請選公里數較少的那條。",
                 "路線重點標題":  "試算看公里數，不看預設藍色路線",
                 "路線重點說明1":  "Google 預設建議通常偏向較快，不一定是距離較短。",
                 "路線範例1":  "較快：16 分｜10.2 km",
                 "路線範例2":  "試算：21 分｜7.9 km（公里數較少）",
                 "路線返回提醒":  "看完後切回 LINE，只要填入該路線的「公里＋分鐘」。",
                 "路線按鈕":  "開啟 Google 地圖查看路線",
                 "已知數字捷徑":  "已經知道公里＋分鐘？直接往下試算",
                 "計算器標題":  "② 填入公里＋分鐘",
                 "計算器徽章":  "立即試算",
                 "計算器說明":  "只填 Google 地圖「公里數較少」路線的兩個數字",
                 "計算器等待":  "輸入兩個數字，立即顯示預估車資",
                 "公里標題":  "公里數",
                 "公里提示":  "例如 7.9",
                 "時間標題":  "預估時間",
                 "時間提示":  "例如 21",
                 ...
                 "人工協助補充":  "若只是想立即知道大概車資，使用上方快速試算會比較快。",
                 "上車標題":  "上車地址",
                 "上車提示":  "請輸入完整地址或明確地標",
                 "下車標題":  "下車地址",
                 "下車提示":  "請輸入完整地址或明確地標",
