(() => {
  ...
  const placePassenger = () => {
    ...
    if (destinationField.nextElementSibling !== passengerField) {
      destinationField.after(passengerField);
    }
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', placePassenger, { once: true });
  } else {
    placePassenger();
  }
})();
